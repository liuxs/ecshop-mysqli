...
class cls_mysql
{
    ...
    {
		$this->link_id = new mysqli($dbhost, $dbuser, $dbpw, $dbname);
		if (!$this->link_id)
            {
                if (!$quiet)
                {
		...
		//echo $this->version."--".$this->dbhash;exit;
    ...
    function ErrorMsg($message = '', $sql = '')
    {
        ...
        if ($message)
        {
         //   echo "<b>ECSHOP info</b>: $message\n\n<br /><br />";
			...
			$someContent="<b>ECSHOP info</b>: $message"."---".date("Y/m/d H:i:s")."---".$_SERVER['PHP_SELF']."---\n";
        }
        else
        {
         ...
         //   print_r($this->error_message);
			...
			$someContent=$this->error_message[2]['error']."---".$this->error_message[3]['errno']."---".date("Y/m/d H:i:s")."---".$this->error_message[1]['sql']."\n"; 
        }

		$fileName="\mnt\qq.txt";
		$handle=@fopen($fileName,"a");
		@fwrite($handle,$someContent.date("Y/m/d H:i:s"));
		@fclose($handle);
		//echo $someContent.date("Y/m/d H:i:s");
        exit;
    }
